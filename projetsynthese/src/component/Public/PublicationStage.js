...
/**
 * Pub pour publier une offre de stage, texte à droite
 */

class PublicationStage extends Component {
    render() {
        return(
            <div className="container-fluid pub-stage-photo" >
                <div className="row" >
                    <div className="col">
...
export default PublicationStage;
